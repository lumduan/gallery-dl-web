...
flowchart TD
    ...
    P8 --> P10["10 · Per-image pacing<br/>the burst nothing was pacing<br/>DONE — v0.7.0"]
    P9 --> P10
    P4 --> P11["11 · The listing outage<br/>a blocking walk is a global outage<br/>DONE — v0.7.0"]
    P4 --> P12["12 · Surviving a reboot<br/>NAS-backed stack + a legible 502<br/>DONE — v0.7.0"]
    P7 --> P13["13 · The unreadable profile<br/>an upstream crash becomes a diagnosis<br/>DONE — v0.7.0"]
    P9 --> P13
